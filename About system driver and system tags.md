...
## Time tags
Last UpdatedFeb 27, 20251 minute read
HMI and SCADASystem PlatformHistorian 2023 R2 SP1 P03
...
This tag has been deprecated and will only be available in systems migrated from AVEVA Historian 2014 and earlier.
...
SysTagHoursQueried A floating point value updated every minute that indicates the total number of "tag retrieval hours" queried by all client applications during that minute. For example, if a single trend queries four tags for a 15-minute period, that is "1.0 tag retrieval hours".
All tags, including replication sync queue tags and non-existent tags, are counted.
...
Last UpdatedFeb 27, 20253 minute readSummarize
HMI and SCADASystem PlatformHistorian 2023 R2 SP1 P03
